...
**
**     Contents  :
**         SetRatio8  - byte PWM_STEERING_RIGHT_SetRatio8(byte Ratio);
**         SetRatio16 - byte PWM_STEERING_RIGHT_SetRatio16(word Ratio);
**         SetDutyUS  - byte PWM_STEERING_RIGHT_SetDutyUS(word Time);
**         SetDutyMS  - byte PWM_STEERING_RIGHT_SetDutyMS(word Time);
**
...
/* MODULE PWM_STEERING_RIGHT. */

#include "PWM_STEERING_RIGHT.h"

#pragma DATA_SEG PWM_STEERING_RIGHT_DATA /* Select data segment "PWM_STEERING_RIGHT_DATA" */

#pragma CODE_SEG PWM_STEERING_RIGHT_CODE
...
/*
** ===================================================================
**     Method      :  PWM_STEERING_RIGHT_SetRatio8 (component PWM)
**
**     Description :
...
** ===================================================================
*/
byte PWM_STEERING_RIGHT_SetRatio8(byte Ratio)
{
...
/*
** ===================================================================
**     Method      :  PWM_STEERING_RIGHT_SetRatio16 (component PWM)
**
**     Description :
...
** ===================================================================
*/
byte PWM_STEERING_RIGHT_SetRatio16(word Ratio)
{
...
/*
** ===================================================================
**     Method      :  PWM_STEERING_RIGHT_SetDutyUS (component PWM)
**
**     Description :
...
** ===================================================================
*/
byte PWM_STEERING_RIGHT_SetDutyUS(word Time)
{
...
/*
** ===================================================================
**     Method      :  PWM_STEERING_RIGHT_SetDutyMS (component PWM)
**
**     Description :
**         This method sets the new duty value of the output signal. The
...
** ===================================================================
*/
byte PWM_STEERING_RIGHT_SetDutyMS(word Time)
{
  dlong rtval;                         /* Result of two 32-bit numbers multiplication */
...
/*
** ===================================================================
**     Method      :  PWM_STEERING_RIGHT_Init (component PWM)
**
**     Description :
...
** ===================================================================
*/
void PWM_STEERING_RIGHT_Init(void)
{
