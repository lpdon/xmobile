...
#pragma DATA_SEG PWM_SUSPENSION_UP_DATA /* Select data segment "PWM_SUSPENSION_UP_DATA" */
...
void PWM_SUSPENSION_UP_Init(void)
{
  ...
  /* PWMDTY2: BIT7=0,BIT6=0,BIT5=0,BIT4=0,BIT3=0,BIT2=0,BIT1=0,BIT0=1 */
  setReg8(PWMDTY2, 0x01U);             /* Store initial value to the duty-compare register */ 
  ...
  /* PWMSCLB: BIT7=0,BIT6=1,BIT5=1,BIT4=1,BIT3=0,BIT2=0,BIT1=0,BIT0=0 */
  setReg8(PWMSCLB, 0x70U);             /* Set scale register */ 
  /* PWMCLK: PCLK2=1 */
