...
#pragma DATA_SEG PWM_STEERING_LEFT_DATA /* Select data segment "PWM_STEERING_LEFT_DATA" */
...
{
  PWMDTY4 = (byte)(((0xFFUL * (dword)RatioStore) + 0x8000UL) >> 0x10U); /* Calculate new value according to the given ratio */
}
...
void PWM_STEERING_LEFT_Init(void)
{
  ...
  /* PWMDTY4: BIT7=0,BIT6=0,BIT5=0,BIT4=0,BIT3=0,BIT2=0,BIT1=0,BIT0=1 */
  setReg8(PWMDTY4, 0x01U);             /* Store initial value to the duty-compare register */ 
  /* PWMPER4: BIT7=1,BIT6=1,BIT5=1,BIT4=1,BIT3=1,BIT2=1,BIT1=1,BIT0=1 */
  ...
  /* PWMSCLA: BIT7=0,BIT6=1,BIT5=1,BIT4=1,BIT3=0,BIT2=0,BIT1=0,BIT0=0 */
  setReg8(PWMSCLA, 0x70U);             /* Set scale register */ 
  /* PWMCLK: PCLK4=1 */
