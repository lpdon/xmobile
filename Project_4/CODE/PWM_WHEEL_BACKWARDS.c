...
**     Filename  : PWM_WHEEL_BACKWARDS.c
**     Project   : Project_4
...
**         Counter                     : PWMCNT1   [$00ED]
**         Mode register               : PWMCTL    [$00E5]
**         Run register                : PWME      [$00E0]
**         Prescaler                   : PWMPRCLK  [$00E3]
**         Compare 1 register          : PWMPER1   [$00F3]
**         Compare 2 register          : PWMDTY1   [$00F9]
...
**
**     Contents  :
**         SetRatio8  - byte PWM_WHEEL_BACKWARDS_SetRatio8(byte Ratio);
**         SetRatio16 - byte PWM_WHEEL_BACKWARDS_SetRatio16(word Ratio);
**         SetDutyUS  - byte PWM_WHEEL_BACKWARDS_SetDutyUS(word Time);
**         SetDutyMS  - byte PWM_WHEEL_BACKWARDS_SetDutyMS(word Time);
**
...
/* MODULE PWM_WHEEL_BACKWARDS. */

#include "PWM_WHEEL_BACKWARDS.h"

#pragma DATA_SEG PWM_WHEEL_BACKWARDS_DATA /* Select data segment "PWM_WHEEL_BACKWARDS_DATA" */

#pragma CODE_SEG PWM_WHEEL_BACKWARDS_CODE
...
/*
** ===================================================================
**     Method      :  PWM_WHEEL_BACKWARDS_SetRatio8 (component PWM)
**
**     Description :
...
** ===================================================================
*/
byte PWM_WHEEL_BACKWARDS_SetRatio8(byte Ratio)
{
...
/*
** ===================================================================
**     Method      :  PWM_WHEEL_BACKWARDS_SetRatio16 (component PWM)
**
**     Description :
...
** ===================================================================
*/
byte PWM_WHEEL_BACKWARDS_SetRatio16(word Ratio)
{
...
/*
** ===================================================================
**     Method      :  PWM_WHEEL_BACKWARDS_SetDutyUS (component PWM)
**
**     Description :
...
** ===================================================================
*/
byte PWM_WHEEL_BACKWARDS_SetDutyUS(word Time)
{
...
/*
** ===================================================================
**     Method      :  PWM_WHEEL_BACKWARDS_SetDutyMS (component PWM)
**
**     Description :
**         This method sets the new duty value of the output signal. The
...
** ===================================================================
*/
byte PWM_WHEEL_BACKWARDS_SetDutyMS(word Time)
{
  dlong rtval;                         /* Result of two 32-bit numbers multiplication */
...
/*
** ===================================================================
**     Method      :  PWM_WHEEL_BACKWARDS_Init (component PWM)
**
**     Description :
...
** ===================================================================
*/
void PWM_WHEEL_BACKWARDS_Init(void)
{
  ...
  /* PWMDTY1: BIT7=0,BIT6=0,BIT5=0,BIT4=0,BIT3=0,BIT2=0,BIT1=0,BIT0=1 */
  setReg8(PWMDTY1, 0x01U);             /* Store initial value to the duty-compare register */ 
  /* PWMPER1: BIT7=1,BIT6=1,BIT5=1,BIT4=1,BIT3=1,BIT2=1,BIT1=1,BIT0=1 */
