...
**         Counter                     : PWMCNT0   [$00EC]
**         Mode register               : PWMCTL    [$00E5]
**         Run register                : PWME      [$00E0]
**         Prescaler                   : PWMPRCLK  [$00E3]
**         Compare 1 register          : PWMPER0   [$00F2]
**         Compare 2 register          : PWMDTY0   [$00F8]
...
**
**     Contents  :
**         SetRatio8  - byte PWM_WHEEL_FORWARDS_SetRatio8(byte Ratio);
**         SetRatio16 - byte PWM_WHEEL_FORWARDS_SetRatio16(word Ratio);
**         SetDutyUS  - byte PWM_WHEEL_FORWARDS_SetDutyUS(word Time);
**         SetDutyMS  - byte PWM_WHEEL_FORWARDS_SetDutyMS(word Time);
**
...
/* MODULE PWM_WHEEL_FORWARDS. */

#include "PWM_WHEEL_FORWARDS.h"

#pragma DATA_SEG PWM_WHEEL_FORWARDS_DATA /* Select data segment "PWM_WHEEL_FORWARDS_DATA" */

#pragma CODE_SEG PWM_WHEEL_FORWARDS_CODE
...
/*
** ===================================================================
**     Method      :  PWM_WHEEL_FORWARDS_SetRatio8 (component PWM)
**
**     Description :
...
** ===================================================================
*/
byte PWM_WHEEL_FORWARDS_SetRatio8(byte Ratio)
{
...
/*
** ===================================================================
**     Method      :  PWM_WHEEL_FORWARDS_SetRatio16 (component PWM)
**
**     Description :
...
** ===================================================================
*/
byte PWM_WHEEL_FORWARDS_SetRatio16(word Ratio)
{
...
/*
** ===================================================================
**     Method      :  PWM_WHEEL_FORWARDS_SetDutyUS (component PWM)
**
**     Description :
...
** ===================================================================
*/
byte PWM_WHEEL_FORWARDS_SetDutyUS(word Time)
{
...
/*
** ===================================================================
**     Method      :  PWM_WHEEL_FORWARDS_SetDutyMS (component PWM)
**
**     Description :
**         This method sets the new duty value of the output signal. The
...
** ===================================================================
*/
byte PWM_WHEEL_FORWARDS_SetDutyMS(word Time)
{
  dlong rtval;                         /* Result of two 32-bit numbers multiplication */
...
/*
** ===================================================================
**     Method      :  PWM_WHEEL_FORWARDS_Init (component PWM)
**
**     Description :
...
** ===================================================================
*/
void PWM_WHEEL_FORWARDS_Init(void)
{
  ...
  /* PWMDTY0: BIT7=0,BIT6=0,BIT5=0,BIT4=0,BIT3=0,BIT2=0,BIT1=0,BIT0=1 */
  setReg8(PWMDTY0, 0x01U);             /* Store initial value to the duty-compare register */ 
  ...
  /* PWME: PWME0=1 */
  setReg8Bits(PWME, 0x01U);            /* Run counter */ 
}

/* END PWM_WHEEL_FORWARDS. */
