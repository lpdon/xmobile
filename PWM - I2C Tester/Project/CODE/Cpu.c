...
void PE_low_level_init(void)
{
  ...
  /* PTT: PTT3=0,PTT2=0,PTT1=1,PTT0=1 */
  clrSetReg8Bits(PTT, 0x0CU, 0x03U);    
  ...
  setReg8(PWME, 0x00U);                 
  /* MODRR: MODRR3=1,MODRR2=1 */
  setReg8Bits(MODRR, 0x0CU);            
  /* PWMCTL: CON23=0,PSWAI=0,PFRZ=0 */
  clrReg8Bits(PWMCTL, 0x2CU);           
  /* PWMCAE: CAE3=0,CAE2=0 */
  clrReg8Bits(PWMCAE, 0x0CU);           
  /* PWMPOL: PPOL3=0,PPOL2=0 */
  clrReg8Bits(PWMPOL, 0x0CU);           
  /* ATDDIEN: IEN0=0 */
  clrReg8Bits(ATDDIEN, 0x01U);          
  ...
  /* DDRE: ??=1,??=1,??=1,??=1 */
  setReg8Bits(DDRE, 0x6CU);             
  /* DDRA: ??=1,??=1,??=1,??=1,??=1,??=1,??=1 */
  setReg8Bits(DDRA, 0xFEU);             
  /* PERS: ??=1,??=1 */
