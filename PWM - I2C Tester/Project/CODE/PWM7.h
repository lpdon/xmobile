...
#define PWM7_PERIOD_VALUE    0xFFUL    /* Initial period value in ticks of the timer */
#define PWM7_PERIOD_VALUE_HIGH 0xFFUL  /* Initial period value in ticks of the timer in high speed mode */
